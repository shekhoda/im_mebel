...
***************************************************************************** */
    ...
    const galleries = document.querySelectorAll(".row-gallery__item");
    if (galleries.length) {
        let galleyItems = [];
    ...
    function documentActions(evt) {
        ...
        if (window.innerWidth > 768 && isMobile.any()) {
            ...
            if (activeLink && !targetElement.classList.contains("_icon-arrow-down")) activeLink.classList.toggle("_sub-active");
        }
    ...
    if (gallery && !isMobile.any()) {
        ...
        gallery.addEventListener("mousemove", (function(evt) {
            const galleryWidth = gallery.offsetWidth;
            const coordX = evt.pageX - galleryWidth / 2;
